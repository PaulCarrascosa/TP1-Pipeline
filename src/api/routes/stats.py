...
def get_most_borrowed_books(
    ...
    return StatsService(db).get_most_borrowed_books(limit=limit)
...
def get_most_active_users(
    ...
    return StatsService(db).get_most_active_users(limit=limit)
...
def get_monthly_loans(
    ...
    return StatsService(db).get_monthly_loans(months=months)
